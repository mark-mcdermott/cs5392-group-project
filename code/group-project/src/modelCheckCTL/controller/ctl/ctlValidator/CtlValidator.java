/* CtlValidator.java */
/* Generated By:JavaCC: Do not edit this line. CtlValidator.java */
...
public class CtlValidator implements CtlValidatorConstants {
...
/** Root production. */
  ...
  public CtlValidatorTokenManager token_source;
  ...
  public CtlValidator(java.io.InputStream stream) {
	  this(stream, null);
  }
  /** Constructor with InputStream and supplied encoding */
  public CtlValidator(java.io.InputStream stream, String encoding) {
	 try { jj_input_stream = new SimpleCharStream(stream, encoding, 1, 1); } catch(java.io.UnsupportedEncodingException e) { throw new RuntimeException(e); }
	 token_source = new CtlValidatorTokenManager(jj_input_stream);
	 token = new Token();
	 jj_ntk = -1;
	 jj_gen = 0;
  ...
  /** Constructor. */
  public CtlValidator(java.io.Reader stream) {
 ...
 token_source = new CtlValidatorTokenManager(jj_input_stream);
  ...
  public CtlValidator(CtlValidatorTokenManager tm) {
	 token_source = tm;
	 token = new Token();
	 jj_ntk = -1;
	 jj_gen = 0;
  ...
  /** Reinitialise. */
  public void ReInit(CtlValidatorTokenManager tm) {
	 token_source = tm;
	 token = new Token();
	 jj_ntk = -1;
	 jj_gen = 0;
